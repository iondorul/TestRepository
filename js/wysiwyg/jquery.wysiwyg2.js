...
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" style="margin:0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body style="margin:0;">INITIAL_CONTENT</body></html>',
		...
		this.editor			= null;  //afjQuery iframe holder
		this.editorDoc		= null;
		this.element		= null;
		this.options		= {};
		this.original		= null;
		...
		this.events = {
			...
			/**
			 * Similar to afjQuery's bind, but for jWysiwyg only.
			 */
			...
			/**
			 * Similar to afjQuery's trigger, but for jWysiwyg only.
			 */
	...
	$(function () { // need access to afjQuery UI stuff.
	...
	$.fn.wysiwyg = function (method) {
		...
		if ("undefined" !== typeof $.wysiwyg[method]) {
			...
			console.error("Method '" +  method + "' does not exist on afjQuery.wysiwyg.\nTry to include some extra controls or plugins");
		}
	};
